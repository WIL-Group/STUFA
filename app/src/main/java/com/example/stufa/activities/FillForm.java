...
public class FillForm extends AppCompatActivity {
    ...
    public void createForm() {
        ...
        else
        {
            ...
            formRer.child(String.valueOf(i + 1)).setValue(form);
            form.setApplicationRefNumber(applicationRefNumber);
            form.setInstNumber(instNumber);
            formRer.child(String.valueOf(i + 1)).setValue(form);
            form.setCourseOrProgramme(courseOrProgramme);
            formRer.child(String.valueOf(i + 1)).setValue(form);
            form.setYearOfStudy(yearOfStudy);
            formRer.child(String.valueOf(i + 1)).setValue(form);
            form.setLastYearOfFunding(lastYearOfFunding);
            formRer.child(String.valueOf(i + 1)).setValue(form);
            form.setCurrentFundingStatus(currentFundingStatus);
            formRer.child(String.valueOf(i + 1)).setValue(form);
